...
exports.ObservationGoalMultiChainConsumer = void 0;
...
let ObservationGoalMultiChainConsumer = class ObservationGoalMultiChainConsumer extends abstract_mc_consumer_1.AbstractMsConsumer {
    constructor(eventStoreService, checkpointService, multichainService) {
        super(`${observation_goal_1.observationGoalStreamRootValue}`, `sync-${observation_goal_1.observationGoalStreamRootValue}-multichain`, eventStoreService, checkpointService, multichainService);
    }
    async publishToEventStore(eventMessage) {
        const event = observation_goal_1.observationGoalEventType.getEvent(eventMessage);
        let result;
        if (event) {
...
ObservationGoalMultiChainConsumer = __decorate([
    common_1.Injectable(),
...
exports.ObservationGoalMultiChainConsumer = ObservationGoalMultiChainConsumer;
//# sourceMappingURL=observation-goal.mc.consumer.js.map