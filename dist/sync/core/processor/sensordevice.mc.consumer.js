...
exports.SensorDeviceMultiChainConsumer = void 0;
...
let SensorDeviceMultiChainConsumer = class SensorDeviceMultiChainConsumer extends abstract_mc_consumer_1.AbstractMsConsumer {
    constructor(eventStoreService, checkpointService, multichainService) {
        super(`${sensordevice_1.sensorDeviceStreamRootValue}`, `sync-${sensordevice_1.sensorDeviceStreamRootValue}-multichain`, eventStoreService, checkpointService, multichainService);
    }
    async publishToEventStore(eventMessage) {
        const event = sensordevice_1.sensorDeviceEventType.getEvent(eventMessage);
        let result;
        if (event) {
...
SensorDeviceMultiChainConsumer = __decorate([
    common_1.Injectable(),
...
exports.SensorDeviceMultiChainConsumer = SensorDeviceMultiChainConsumer;
//# sourceMappingURL=sensordevice.mc.consumer.js.map